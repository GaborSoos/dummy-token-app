...
import com.example.springsecuritydemo.security.PlayerDto;
import com.example.springsecuritydemo.security.SecurityConstants;
        ...
        if (jwt == null) {
            ...
            try {
                ...
                Authentication auth = new UsernamePasswordAuthenticationToken(
                        new PlayerDto(-1, username, kingdomId, kingdomName, null, null),
                        null,
                        null);
